...
class ReleaseArtifactsTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.iso = self.root / "lyra-os.x86_64-2026.08-beta2.iso"
        self.iso.write_bytes(b"fake iso payload")
        self.packages = self.root / "lyra-os.x86_64-2026.08-beta2.packages"
        ...
        self.verified = self.root / "lyra-os.x86_64-2026.08-beta2.verified"
